                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="hero-singel-slide ">
                                    <div class="hero-bg">
                                        <img width="388" height="160" class="img-full" src="<?= base_url('assets/images/carousel/1.jpg');?>" alt="image">
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="hero-singel-slide">
                                    <div class="hero-bg">
                                        <img width="388" height="160" class="img-full" src="<?= base_url('assets/images/carousel/2.jpg');?>" alt="image">
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="hero-singel-slide">
                                    <div class="hero-bg">
                                        <img width="388" height="160" class="img-full" src="<?= base_url('assets/images/carousel/3.jpg');?>" alt="image">
                                    </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <a href="shop.html" class="btn"><span class="icon"><img width="33" height="33"
												src="assets/images/catagories/sneakers.png" alt="image"></span> Sneakers</a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="shop.html" class="btn"><span class="icon"><img width="33" height="33"
												src="assets/images/catagories/watch.png" alt="image"></span>Watch</a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="shop.html" class="btn"><span class="icon"><img width="33" height="33"
												src="assets/images/catagories/headphones.png" alt="image"></span>Gadget</a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="shop.html" class="btn"><span class="icon"><img width="33" height="33"
												src="assets/images/catagories/bagpack.png" alt="image"></span>Bagpack</a>
                                </div>
                            </div>
                        </div>
                    </div>
